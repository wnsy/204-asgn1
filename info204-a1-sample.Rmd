...
### Seek website
- go to seek website, 
- CSS selector for the search results of each job title `#SearchSummary`
...
# emp.data <- data.frame(
#    get.job.titles = c(clean.jobtitles.data),
#    countries.in.demand = c(raw.paragraphs.countries),
