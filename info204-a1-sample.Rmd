...
We know that the required URL to get the components from is https://www.westernunion.com/blog/jobs-in-demand/, and as we scroll down, we are able to identify the job titles headings and sub headings, like below:
...
We want to take the countries which are repeated under the different job categories as this will show us what skills each country lacks and if they lack multiple skills then we have more data to back it up and is more reliable to claim that so and so country requires [job1] and [job2] and see if there are specific trends between countries in terms of the jobs in demand. 

Image for first website
...
This is the website showing the 


![This is how we get data using the Chrome Developer Tools](images/chrome-dev-tools.png)


![This is how we get data using the Chrome Developer Tools](images/chrome-dev-tools2.png)
